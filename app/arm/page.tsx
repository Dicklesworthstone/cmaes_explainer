      ...
      <main className="mx-auto max-w-7xl px-6 pt-16 pb-28 lg:pt-20 lg:pb-24">
        <section className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-400">
            Seven joint target curves plus one gripper-width curve, sampled at sixteen knots: 128
            variables optimized against a piecewise physical objective that never leaks a gradient.
          </p>
        </section>
        ...
        <section className="mx-auto mt-16 max-w-3xl space-y-6 text-sm leading-7 text-slate-300">
          ...
          <p>
            Seven joint target curves and one gripper-width curve are sampled at sixteen knots — 128
            CMA-ES variables. The objective is assembled from a full LBR iiwa 7 R800 rollout with
            contact activation, static-slip friction capacity, free-space dynamics, release timing,
            hard limits, and an owner-routed obstacle/self/object separation — piecewise and
            black-box by construction. There is no browser-side gradient to hide behind, and the
            grasp is only claimed when the receipt verifies it.
          </p>
          <p>
            At 128 dimensions all four scalable representations (Full, Separable, LM-CMA, LM-MA) fit
            the honest browser envelope, so this section is where the family race is physically
            meaningful — Full CMA is pedagogically useful here and rightly refused for the 5,040-D
