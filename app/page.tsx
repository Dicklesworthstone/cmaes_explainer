                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="rounded-2xl border border-cyan-400/30 bg-slate-950/80 p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-300">
                        Watch a 29-DoF Unitree G1 humanoid optimize a 5,040-parameter locomotion
                        policy live in your browser. Features whole-house 3D waypoint navigation
                        across 7 rooms, zero-penetration collision detection, and ragdoll dragging.
                      </p>
                  ...
                  <div className="rounded-2xl border border-orange-400/30 bg-slate-950/80 p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-300">
                        A source-bound 7-DoF KUKA LBR iiwa 7 R800 is optimized to reach, grasp,
                        transport, and release objects in three reduced household scenes. Placement
                        is accepted only when the collision receipt is clear.
                      </p>
                      <ul className="mt-4 space-y-2 text-xs text-slate-400">
                        <li className="flex items-center gap-2">
                        ...
                        <li className="flex items-center gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-orange-400" />
                          <span>Interactive 360° camera orbit & grasp microscope inspection</span>
                        </li>
                      </ul>
                    </div>
                    <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
