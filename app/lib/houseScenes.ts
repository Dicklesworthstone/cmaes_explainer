  ...
  furniture: [
    {
      ...
      height: 1.3,
      rotation: 0,
      note: "brick surround, catalog feature",
    },
    {
      name: "sofa",
      room: "living room",
      ...
      height: 0.8,
      rotation: 0,
      note: "period Mission-style silhouette",
    },
    {
      name: "library table",
      room: "living room",
    ...
    // aperture x[1.025,1.975]@y=0.7 stays navigable at robotRadius 0.20.
    {
      ...
      height: 0.92,
      rotation: 0,
      note: "hoosier-style work table (sized for doorway clearance)",
    },
    {
      name: "stove",
      room: "kitchen",
    ...
    },
    {
      ...
      height: 1.9,
      rotation: 0,
      note: "built-in craftsman shelving",
    },
    {
      name: "armchair-1",
      room: "living room",
    ...
    },
    {
      ...
      rotation: -0.3,
      kind: "armchair",
      materialId: "fabric-leather",
      note: "leather armchair",
    },
    {
      name: "lamp-table",
      room: "living room",
    ...
    // wall; previously covered the west half of the dining/kitchen doorway.
    {
      ...
      kind: "console-table",
      materialId: "oak-wood",
      note: "Craftsman sideboard with drawers",
    },
    {
      name: "rug-dining",
      room: "dining room",
    ...
    },
    {
      ...
      kind: "range-hood",
      materialId: "chrome",
      note: "wall-mounted hood above stove",
    },
    {
      name: "plate-1",
      room: "kitchen",
    ...
    },
    {
      ...
      note: "armoire with double doors",
    },
    {
      name: "book-bedroom",
      room: "bedroom",
    ...
    },
    {
      ...
      materialId: "oak-wood",
      articulation: [
        { name: "drawer", type: "prismatic", axis: [1, 0, 0], limits: { min: 0, max: 0.4 } },
      ],
      note: "writing desk",
    },
    {
    ...
    },
    {
      ...
      materialId: "porcelain",
      articulation: [
        { name: "lid", type: "revolute", axis: [0, 1, 0], limits: { min: 0, max: 1.5707963 } },
      ],
      note: "two-piece toilet",
    },
    {
      name: "vanity",
      room: "bath",
    ...
    },
    {
      ...
      kind: "pet-cat",
      materialId: "fabric-cotton",
      note: "cat sleeping by fireplace (display-only)",
    },
    {
      name: "person-silhouette-kitchen",
      room: "kitchen",
      center: [2.0, -1.5],
      size: [0.45, 0.25],
      height: 1.75,
      ...
      materialId: "fabric-cotton",
      note: "person at stove (display-only)",
    },
  ],
...
export const ARM_COUNTER_PLACEMENTS: Record<string, ArmCounterPlacement> = {
  "kitchen-mug": {
...
export function armTaskFurniture(task: string): {
  ...
  const goal = CRAFTSMAN_BUNGALOW_1928.furniture.find((f) => f.name === placement.goalFurniture);
