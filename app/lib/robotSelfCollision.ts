...
const G1_ADJACENT_PAIRS = new Set<string>([
  ...
  "torso:left_hip_pitch",
  "torso:left_hip_roll",
  "torso:left_hip_yaw",
  "torso:right_hip_pitch",
  "torso:right_hip_roll",
  "torso:right_hip_yaw",
  // Left leg
  "pelvis:left_hip_pitch",
  "pelvis:left_hip_roll",
  "pelvis:left_hip_yaw",
  "left_hip_pitch:left_hip_roll",
  "left_hip_pitch:left_hip_yaw",
  "left_hip_pitch:left_knee",
  "left_hip_roll:left_hip_yaw",
  "left_hip_roll:left_knee",
  "left_hip_yaw:left_knee",
  "left_hip_yaw:left_ankle_pitch",
  "left_knee:left_ankle_pitch",
  "left_knee:left_ankle_roll",
  "left_ankle_pitch:left_ankle_roll",
  // Right leg
  "pelvis:right_hip_pitch",
  "pelvis:right_hip_roll",
  "pelvis:right_hip_yaw",
  "right_hip_pitch:right_hip_roll",
  "right_hip_pitch:right_hip_yaw",
  "right_hip_pitch:right_knee",
  "right_hip_roll:right_hip_yaw",
  "right_hip_roll:right_knee",
  "right_hip_yaw:right_knee",
  "right_hip_yaw:right_ankle_pitch",
  "right_knee:right_ankle_pitch",
  "right_knee:right_ankle_roll",
  "right_ankle_pitch:right_ankle_roll",
  // Left arm
  "torso:left_shoulder_pitch",
  "torso:left_shoulder_roll",
  "torso:left_shoulder_yaw",
  ...
  "left_shoulder_yaw:left_wrist_roll",
  ...
  // Right arm
  "torso:right_shoulder_pitch",
  "torso:right_shoulder_roll",
  "torso:right_shoulder_yaw",
  ...
  "right_shoulder_yaw:right_wrist_roll",
...
export function checkG1SelfCollision(
  links: LinkCapsule[],
  safetyMargin = 0.005,
): SelfCollisionResult {
...
export function checkArmSelfCollision(
  links: LinkCapsule[],
  safetyMargin = 0.005,
): SelfCollisionResult {
