...
import { JETBRAINS_MONO_MEDIUM_B64, MANROPE_EXTRA_BOLD_B64, MANROPE_MEDIUM_B64 } from "./fontData";
...
function arrowAt(x: number, y: number, angleDeg: number, size: number): string {
  ...
  return (
    ...
    tipY.toFixed(2) +
    " L " +
    (bx + vx * size * 0.55).toFixed(2) +
    " " +
    (by + vy * size * 0.55).toFixed(2) +
    " L " +
    (bx - vx * size * 0.55).toFixed(2) +
    " " +
    (by - vy * size * 0.55).toFixed(2) +
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(56,189,248,0.16) 0%, rgba(56,189,248,0.05) 45%, transparent 68%)",
          display: "flex",
        }}
      />
      <div
      ...
      >
        ...
        <h1
          style={{
            ...
            letterSpacing: -3,
            background:
              "linear-gradient(105deg, #f8fafc 0%, #e0f2fe 38%, #7dd3fc 68%, #38bdf8 100%)",
            backgroundClip: "text",
            color: "transparent",
          }}
        >
        ...
        >
          Watch a population learn the shape of a landscape, then run the real Rust engine live in
          your browser.
        </div>
        ...
        <div
          style={{ display: "flex", alignItems: "center", gap: 12, marginTop: compact ? 30 : 40 }}
        >
          <div
            style={{
              width: 44,
        ...
        >
          ...
          >
            ...
            <path
              d={CONTOURS[0].d}
              stroke="#38bdf8"
              strokeWidth={CONTOURS[0].width}
              opacity={CONTOURS[0].opacity}
              fill="none"
            />
            <path
              d={CONTOURS[1].d}
              stroke="#38bdf8"
              strokeWidth={CONTOURS[1].width}
              opacity={CONTOURS[1].opacity}
              fill="none"
            />
            <path
              d={CONTOURS[2].d}
              stroke="#38bdf8"
              strokeWidth={CONTOURS[2].width}
              opacity={CONTOURS[2].opacity}
              fill="none"
            />
            <path
              d={CONTOURS[3].d}
              stroke="#38bdf8"
              strokeWidth={CONTOURS[3].width}
              opacity={CONTOURS[3].opacity}
              fill="none"
            />
            <path
              d={CONTOURS[4].d}
              stroke="#38bdf8"
              strokeWidth={CONTOURS[4].width}
              opacity={CONTOURS[4].opacity}
              fill="none"
            />
      ...
      <div
        style={{
          ...
          display: "flex",
          background:
            "linear-gradient(90deg, transparent 0%, #38bdf8 28%, #22d3ee 55%, #34d399 80%, transparent 100%)",
        }}
      />
    </div>,
    { width, height, fonts },
