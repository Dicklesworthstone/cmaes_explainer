...
if (Symbol.dispose)
  G1TransformerTrainerSession.prototype[Symbol.dispose] =
    G1TransformerTrainerSession.prototype.free;
...
if (Symbol.dispose)
  G1WalkingVizEvaluator.prototype[Symbol.dispose] = G1WalkingVizEvaluator.prototype.free;
...
export class HouseholdManipulationVizEvaluator {
  ...
  evaluate_population(parameters) {
    const ptr0 = passArrayF64ToWasm0(parameters, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.householdmanipulationvizevaluator_evaluate_population(
      this.__wbg_ptr,
      ptr0,
      len0,
    );
...
if (Symbol.dispose)
  HouseholdManipulationVizEvaluator.prototype[Symbol.dispose] =
    HouseholdManipulationVizEvaluator.prototype.free;
...
function __wbg_get_imports() {
  const import0 = {
    __proto__: null,
    __wbg___wbindgen_throw_bb96b2010945f0bc: (arg0, arg1) => {
