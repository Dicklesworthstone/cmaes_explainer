...
export function gray_scott_frames(
  n: number,
  frames: number,
  feed: number,
  kill: number,
...
export function mandelbrot_certified(
  w: number,
  h: number,
  cx: number,
  cy: number,
...
export function navier_stokes_cavity(
  cells: number,
  frames: number,
  re: number,
...
export function orr_sommerfeld_curve(
  alpha: number,
  n: number,
  re_min: number,
  re_max: number,
...
export function schedule_campaign(
  windtunnel_latency: number,
  design_b_mean: number,
  stop_threshold: number,
): Float64Array;

export function sdf_volume(res: number, kind: number, t: number): Float64Array;

export function sensorforge(
  threshold: number,
  max_sensors: number,
  b_prior_mean: number,
): Float64Array;
