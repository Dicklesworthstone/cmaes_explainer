...
export const lenia_clear: () => void;
export const lenia_eval: (a: number, b: number, c: number, d: number) => [number, number];
export const lenia_init: (a: number, b: number, c: number) => [number, number];
